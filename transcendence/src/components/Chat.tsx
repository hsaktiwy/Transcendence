...
function Chat(){
    ...
    return(
        <div className=" h-screen bg-[rgba(0,0,0,0.7)] w-[95%] m-auto rounded-sm grid grid-cols-12 grid-rows-12 gap-2 p-4">
            <Sidebar/>
            <NavBar/>
            <div className = "rounded-lg shadow-xl  col-span-12 lg:col-span-11 row-span-11 grid grid-cols-12 grid-rows-12 gap-4">
                <div className="bg-[#FFFFFF] rounded-lg shadow-xl col-span-3 lg:col-span-4 row-span-12">conversations</div>
                <ChatSession/>
            </div>
