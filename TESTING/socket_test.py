...
#     ws_url = "wss://10.11.6.2:4444/api/ws/chat/"
...
def authenticate(username: str, password: str):
    ...
    # csrf_url = "https://10.11.6.2:4444/api/cookie"
    ...
    auth_url = "https://10.11.6.2:4444/api/api/user/login/"
...
async def connect_websocket(csrf_token: str, access_token: str):
    ...
    ws_url = "wss://10.11.6.2:4444/api/ws/ping-pong/room"
