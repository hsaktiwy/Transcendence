...
function NoActiveChat(){
    return(
        <div className=' font-poppins overflow-hidden lg:left-[30%] xl:left-[22%] absolute w-0 lg:w-[70%] xl:w-[78%] hidden lg:flex flex-col justify-center items-center h-full'>
            ...
            <div className='w-[500px] h-[500px]  rounded-lg  flex flex-col items-center pt-4 text-center gap-8'>
                <div className='w-[150px] h-[150px] bg-gradient-to-b from-slate-400/30 to-cyan-400/60 rounded-full flex justify-center items-center'>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="124" height="124" color="rgba(255,255,255,0.5)" fill="none">
                ...
                <h1 className='text-4xl text-white/80 font-semibold'>No Active Conversation</h1>
                <p className='text-white/50'>Start a conversation and begin interacting with your friends</p>
            </div>
