...
const TfaVerifiedModal:React.FC<prop> = ({dispatch}) =>{
    ...
    return(
        ...
        className="h-[100%] w-[100%] fixed  top-0 -left-0 backdrop-filter backdrop-blur-sm bg-black/40  z-50 flex justify-center items-center">
            <motion.div
            variants={ModalFade()}
            initial='modalInitial'
            animate='modalAnimate'
            className="mx-auto sm:mx-0  bg-gradient-to-br from-[#323339] via-[#28292F] to-[#232628] w-[90%] sm:w-[500px] rounded-xl flex flex-col  gap-4 px-2 py-4 text-white">
