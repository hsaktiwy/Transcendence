                            ...
                            <div className="w-full  h-full  grid grid-rows-2 ">
                                <div className=" bg-gradient-to-r from-[#292d30] to-[#1D1E22] shadow-md   px-5 lg:px-10  rounded-3xl grid grid-rows-1 ">
                                    <div className=" h-20 hidden sm:flex items-center xxl:items-end ">
                                        <div className="   h-10 min-w-40 xxl:h-14 xxl:min-w-48 border border-[#5E97A9] rounded-2xl sm:flex justify-center items-center">
                                            <div className=" text-xl text-[#5E97A9] font-semibold xxl:text-xl ">{`${profileData?.login}`}</div>
                                        </div>
                                    </div>
