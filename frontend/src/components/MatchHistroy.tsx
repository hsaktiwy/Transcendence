                    ...
                    <div className="p-3  w-full h-full grid grid-rows-6 ">
                      <div className="row-span-2  px-6 flex items-center justify-between w-full">
                          <div className="flex items-center justify-center flex-col gap-3">
                              <img className="size-14 lg;size-18  xxl:size-24 rounded-full aspect-square  object-cover" src={`${axiosPath}${userContextConsumer.userData?.profile_pic}`} alt="user-image" />
                          ...
                          <div className="flex items-center justify-center flex-col gap-3">
                              <img className="size-14   xxl:size-24 aspect-square rounded-full object-cover" src={`${axiosPath}${userContextConsumer.userData?.profile_pic}`} alt="user-image" />
                              <div className="text-base font-medium  xxl:text-base ">{` ${userContextConsumer.userData?.firstName}`}</div>
                           </div>
                      </div>
                          ...
                          <div className="h-40 xxl:h-60 overflow-y-auto px-5">
                                      ...
                                      <div className="  w-full mr-4">
                                        <div className=" flex  items-center">
                                              <div className="min-w-32 w-[100%] h-full  flex items-center">
                                                  <img className="w-11 rounded-full aspect-square rounded-full object-cover" src={`${axiosPath}${userContextConsumer.userData?.profile_pic}`} alt="user-image" />
                                                      <div className="mx-3">
                                  ...
                                  <div className="w-full  flex items-center  bg-gradient-to-b from-[#2B2F32] gap-4 to-[#1D1E22] shadow-lg rounded-lg py-4 ">
                                      ...
                                      <div className="  w-full mr-4">
                                        <div className=" flex  items-center">
                                              <div className="min-w-32 w-[100%] h-full  flex items-center">
                                                  <img className="w-11 aspect-square rounded-full object-cover" src={`${axiosPath}${userContextConsumer.userData?.profile_pic}`} alt="user-image" />
                                                      <div className="mx-3">
                                                        <h1 className="font-medium text-xs">Hamza Chahboune</h1>
                                                        <h1 className="font-normal opacity-80 text-xs text-left">@hachahbo</h1>
                                                      </div>
