...
function GeneralSettings(){
    ...
    return (
      ...
      <form onSubmit={handleSubmit} className=" general-settings m-4 sm:m-16  h-[1000px] flex-1 bg-gradient-to-br from-[#283137] to-[#242729] rounded-xl p-16 flex justify-center flex-col items-center gap-20 relative">
