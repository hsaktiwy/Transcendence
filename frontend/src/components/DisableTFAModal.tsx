    ...
    return(
        <div className="h-[100%] w-[100%] fixed  top-0 -left-0 backdrop-filter backdrop-blur-sm bg-black/40  z-50  flex justify-center items-center ">
            <div className=" bg-gradient-to-br from-[#323339] via-[#28292F] to-[#232628] w-[90%] sm:w-[500px] rounded-xl flex flex-col  gap-4 px-2 py-4 text-white   animate-jump ">
                <div className="flex justify-between text-xl items-center text-white/70">
                ...
                <div className=" flex flex-col items-center justify-center gap-4">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="200" height="200" color="#e53f3f" fill="none">
                    ...
                    <h1 className="text-2xl font-bold text-center">Are you sure you want to disable Two Factor Authentication</h1>
                    <div className="flex justify-center gap-5 items-center flex-wrap">
                        <button type="button" className="m-6 rounded-3xl px-2 py-4  bg-white text-black text-lg  w-[150px] opacity-85 hover:opacity-100 duration-75 tracking-widest font-semibold" onClick={()=>{
                            disableTFA()
                            dispatch(false)
                            userContextConsumer.setUserData( prev => ({...prev!, two_factor_auth: true}))
                        }}>Confirm</button>
                        <button type="button" className="m-6 rounded-3xl px-2 py-4   text-white text-lg   border-[1px] w-[150px] opacity-85 hover:opacity-100  duration-75 tracking-widest font-semibold" onClick={()=>{
                            dispatch(false)
                            userContextConsumer.setUserData( prev => ({...prev!, two_factor_auth: true}))
                        }}>Discard</button>
