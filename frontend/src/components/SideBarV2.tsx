...
function SideBarV2(){
    ...
    return (
        ...
        <div className="font-poppins h-[60px] w-full lg:h-[98%] lg:w-[120px]    z-50   bg-gradient-to-br  from-[#2a3236] to-[#1e2124] lg:from-[#2a3236] lg:to-[#1e2124] fixed bottom-0 lg:rounded-2xl lg:ml-3 lg:top-2 2xl:top-3 left-0 text-white flex flex-row lg:flex-col items-center justify-center ">
