...
function SideBarV2(){
    ...
    return (
            ...
            <aside className={`font-poppins h-[60px] w-full lg:h-full lg:w-[80px] shadow-lg shadow-white/25 bg-[#1D1E22] fixed bottom-0 lg:top-0 left-0 text-white backdrop-filter backdrop-blur-md  flex flex-row lg:flex-col items-center justify-between z-10  `} >
