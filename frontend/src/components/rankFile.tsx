...
function RankFile() {
  return (
    <div className=" 2xl:col-span-2 rounded-2xl  bg-[#2B2F32]  text-center text-xl text-white h-full  ">
                        <div className=" flex justify-center items-center p-5 2xl:col-span-2 rounded-2xl pb-6 bg-gradient-to-tr from-[#2f3a41] to-[#2B2F32]  shadow-3xl shadow-[#22333869] rounded-text-center text-xl text-white h-full  ">
