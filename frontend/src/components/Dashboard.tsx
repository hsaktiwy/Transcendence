...
function Dashboard(){
    ...
    return(
        ...
        <div className=" row-span-4 md:col-span-12 md:row-span-4 xl:col-span-8 xl:row-span-3 2xl:col-span-6 2xl:row-span-6">
             <div className=" rounded-lg p-4 flex   gap-2 overflow-hidden">
        ...
        <div className="border hidden 2xl:block xl:col-span-4 xl:row-span-6 2xl:col-span-3 2xl:row-span-6">
        ...
        <div className="border row-span-4 hidden xl:block xl:col-span-4 xl:row-span-6 2xl:col-span-3 2xl:row-span-7">
