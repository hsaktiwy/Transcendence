...
function Settings() {
    ...
    return(
        ...
        <div className=" font-poppins absolute left-0 lg:left-[80px] top-[60px] w-[calc(100vw-20px)] lg:w-[calc(100vw-100px)] m-[10px] text-white bg-black/35 backdrop-filter backdrop-blur-sm  rounded-xl relattive">
                ...
                <div className="group user-pic h-[120px] w-[120px] absolute top-[20vh] left-[50%] -translate-x-[50%] rounded-full  after:content-[''] after:absolute after:h-[120px] after:w-[120px] after:rounded-full after:bg-black/45 z-50 after:top-0 after:left-[50%] after:-translate-x-[50%] after:border-[5px] after:border-white/50 grop">
                    <img src={userContextConsumer.userData?.profile_pic} alt="user-pic" className="rounded-full object-cover"/>
                </div>
